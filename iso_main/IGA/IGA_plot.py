...
class IGA_Plot: 
	...
	def rawPlot(self):
		...
		for experiment in self.analyse.blanks:
			...
			self.ads_blankManyPath = '%s/IGA/IGA_plots/Blank_plots/Many_plots/Adsorption/Raw_Runs_Ads_plot_%s_%s.png'%(os.getcwd(), experiment["name"], experiment["element"])
			...
			self.ads_blankManyPath = '%s/IGA/IGA_plots/Blank_plots/Many_plots/Desorption/Raw_Runs_Des_plot_%s_%s.png'%(os.getcwd(), experiment["name"], experiment["element"])
			plt.savefig('%s'%self.ads_blankManyPath)
			plt.close()
		...
		for experiment in self.analyse.aliqs:
			...
			self.ads_blankManyPath = '%s/IGA/IGA_plots/Aliq_plots/Many_plots/Adsorption/Raw_Runs_Ads_plot_%s_%s.png'%(os.getcwd(), experiment["name"], experiment["element"])
			plt.savefig('%s'%self.ads_blankManyPath)
			plt.close()
			...
			self.ads_blankManyPath = '%s/IGA/IGA_plots/Aliq_plots/Many_plots/Desorption/Raw_Runs_Des_plot_%s_%s.png'%(os.getcwd(), experiment["name"], experiment["element"])
			plt.savefig('%s'%self.ads_blankManyPath)
			plt.close()
	...
	def alignedPlot(self):
		...
		for experiment in self.analyse.blanks:
			...
			self.ads_blankManyPath = '%s/IGA/IGA_plots/Blank_plots/Many_plots/Adsorption/Aligned_Runs_Ads_plot_%s_%s.png'%(os.getcwd(), experiment["name"], experiment["element"])
			plt.savefig('%s'%self.ads_blankManyPath)
			plt.close()
			...
			self.ads_blankManyPath = '%s/IGA/IGA_plots/Blank_plots/Many_plots/Desorption/Aligned_Runs_Des_plot_%s_%s.png'%(os.getcwd(), experiment["name"], experiment["element"])
			plt.savefig('%s'%self.ads_blankManyPath)
			plt.close()
		...
		for experiment in self.analyse.aliqs:
			...
			self.ads_blankManyPath = '%s/IGA/IGA_plots/Aliq_plots/Many_plots/Adsorption/Aligned_Runs_Ads_plot_%s_%s.png'%(os.getcwd(), experiment["name"], experiment["element"])
			plt.savefig('%s'%self.ads_blankManyPath)
			plt.close()
			...
			self.ads_blankManyPath = '%s/IGA/IGA_plots/Aliq_plots/Many_plots/Desorption/Aligned_Runs_Des_plot_%s_%s.png'%(os.getcwd(), experiment["name"], experiment["element"])
			plt.savefig('%s'%self.ads_blankManyPath)
			plt.close()
	...
	def rawDiffPlot(self):
		...
		for experiment in self.analyse.blanks:
			...
			self.ads_blankManyPath = '%s/IGA/IGA_plots/Blank_plots/Diff_plots/Adsorption/Raw_Diffs_Ads_plot_%s_%s.png'%(os.getcwd(), experiment["name"], experiment["element"])
			plt.savefig('%s'%self.ads_blankManyPath)
			plt.close()
			...
			self.ads_blankManyPath = '%s/IGA/IGA_plots/Blank_plots/Diff_plots/Desorption/Raw_Diffs_Des_plot_%s_%s.png'%(os.getcwd(), experiment["name"], experiment["element"])
			plt.savefig('%s'%self.ads_blankManyPath)
			plt.close()
		...
		for experiment in self.analyse.aliqs:
			...
			self.ads_blankManyPath = '%s/IGA/IGA_plots/Aliq_plots/Diff_plots/Adsorption/Raw_Diffs_Ads_plot_%s_%s.png'%(os.getcwd(), experiment["name"], experiment["element"])
			plt.savefig('%s'%self.ads_blankManyPath)
			plt.close()
			...
			self.ads_blankManyPath = '%s/IGA/IGA_plots/Aliq_plots/Diff_plots/Desorption/Raw_Diffs_Des_plot_%s_%s.png'%(os.getcwd(), experiment["name"], experiment["element"])
			plt.savefig('%s'%self.ads_blankManyPath)
			plt.close()
	...
	def alignedDiffPlot(self):
		...
		for experiment in self.analyse.blanks:
			...
			self.ads_blankManyPath = '%s/IGA/IGA_plots/Blank_plots/Diff_plots/Adsorption/Aligned_Diffs_Ads_plot_%s_%s.png'%(os.getcwd(), experiment["name"], experiment["element"])
			plt.savefig('%s'%self.ads_blankManyPath)
			plt.close()
			...
			self.ads_blankManyPath = '%s/IGA/IGA_plots/Blank_plots/Diff_plots/Desorption/Aligned_Diffs_Des_plot_%s_%s.png'%(os.getcwd(), experiment["name"], experiment["element"])
			plt.savefig('%s'%self.ads_blankManyPath)
			plt.close()
		...
		for experiment in self.analyse.aliqs:
			...
			self.ads_blankManyPath = '%s/IGA/IGA_plots/Aliq_plots/Diff_plots/Adsorption/Aligned_Diffs_Ads_plot_%s_%s.png'%(os.getcwd(), experiment["name"], experiment["element"])
			plt.savefig('%s'%self.ads_blankManyPath)
			plt.close()
			...
			self.ads_blankManyPath = '%s/IGA/IGA_plots/Aliq_plots/Diff_plots/Desorption/Aligned_Diffs_Des_plot_%s_%s.png'%(os.getcwd(), experiment["name"], experiment["element"])
			plt.savefig('%s'%self.ads_blankManyPath)
			plt.close()
	...
	def alignedAveragePlot(self):
		...
		for experiment in self.analyse.blanks:
			...
			self.ads_blankManyPath = '%s/IGA/IGA_plots/Blank_plots/Simple_plots/Aligned_Average_plot_%s_%s.png'%(os.getcwd(), experiment["name"], experiment["element"])
			plt.savefig('%s'%self.ads_blankManyPath)
			plt.close()
		...
		for experiment in self.analyse.aliqs:
			...
			self.ads_blankManyPath = '%s/IGA/IGA_plots/Aliq_plots/Simple_plots/Aligned_Average_plot_%s_%s.png'%(os.getcwd(), experiment["name"], experiment["element"])
			plt.savefig('%s'%self.ads_blankManyPath)
			plt.close()
...
######################################### Many_plot Functions #########################################
	...
	def ads_aliqManyPlot(self, manyList, label='unknown', xmin = 0, ymin = 0, xmax = 45, ymax = 20):
		...
		self.ads_aliqManyPath = '%s/IGA/IGA_plots/Aliq_plots/Many_plots/Adsorption/many_plot_%s.png'%(os.getcwd(), label)
	...
	def des_aliqManyPlot(self, manyList, label='unknown', xmin = 0, ymin = 0, xmax = 45, ymax = 20):
		...
		self.des_aliqManyPath = '%s/IGA/IGA_plots/Aliq_plots/Many_plots/Desorption/many_plot_%s.png'%(os.getcwd(), label)
	...
	def ads_blankManyPlot(self, manyList, label='unknown', xmin = 0, ymin = 0, xmax = 45, ymax = 1.2):
		...
		self.ads_blankManyPath = '%s/IGA/IGA_plots/Blank_plots/Many_plots/Adsorption/many_plot_%s.png'%(os.getcwd(), label)
		plt.savefig('%s'%self.ads_blankManyPath)
		plt.close()
	...
	def des_blankManyPlot(self, manyList, label='unknown', xmin = 0, ymin = 0, xmax = 45, ymax = 1.2):
		...
		self.des_blankManyPath = '%s/IGA/IGA_plots/Blank_plots/Many_plots/Desorption/many_plot_%s.png'%(os.getcwd(), label)
...
######################################### Diff_plot Functions #########################################
	...
	def des_blankDiffPlot(self, listOne, listTwo, listDiff, label='unkown', index=0,\
		...
		self.des_blankDiffPath = '%s/IGA/IGA_plots/Blank_plots/Diff_plots/Desorption/diff_plot_%s_%d.png'\
	...
	def ads_blankDiffPlot(self, listOne, listTwo, listDiff, label='unknown', index=0,\
		...
		self.ads_blankDiffPath = '%s/IGA/IGA_plots/Blank_plots/Diff_plots/Adsorption/diff_plot_%s_%d.png'\
					 	 			  %(os.getcwd(), label, index)
	...
	def des_aliqDiffPlot(self, listOne, listTwo, listDiff, label='unknown', index=0,\
		...
		self.des_aliqDiffPath = '%s/IGA/IGA_plots/Aliq_plots/Diff_plots/Desorption/diff_plot_%s_%d.png'\
					 	 			  %(os.getcwd(), label, index)
	...
	def ads_aliqDiffPlot(self, listOne, listTwo, listDiff, label='unknown', index=0,\
		...
		self.ads_aliqDiffPath = '%s/IGA/IGA_plots/Aliq_plots/Diff_plots/Adsorption/diff_plot_%s_%d.png'\
					 	 			  %(os.getcwd(), label, index)
...
######################################### Simple_plot Functions #########################################
	...
	def aliqSimplePlot(self, listOne, listTwo, label='unknown', legendOne = 'unknown',\
		...
		self.aliq_SimplePath = '%s/IGA/IGA_plots/Aliq_plots/Simple_plots/simple_plot_%s.png'\
					 	 		 %(os.getcwd(), label)
	...
	def blankSimplePlot(self, listOne, listTwo, label='unknown', legendOne = 'unknown',\
		...
		self.blank_SimplePath = '%s/IGA/IGA_plots/Blank_plots/Simple_plots/simple_plot_%s.png'\
					 	 		 %(os.getcwd(), label)
